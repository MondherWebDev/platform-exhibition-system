          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={async () => {
                  try {
                    // Export all users data as CSV with Arabic support
                    const csvData = users.map(u => ({
                      ...
                      'Position': u.position || '',
                      'Category': u.category || '',
                      'Phone': u.countryCode && (u.mobile || u.phone)
                        ? `${u.countryCode} ${u.mobile || u.phone}`.replace('++', '+')
                        : (u.mobile || u.phone || ''),
                      'Industry': u.industry || '',
                      'Country': u.countryCode ? (() => {
                        const countryMap: { [key: string]: string } = {
                          ...
                          '+262': 'Réunion', '+263': 'Zimbabwe', '+264': 'Namibia', '+265': 'Malawi',
                          ...
                          '+597': 'Suriname', '+598': 'Uruguay', '+599': 'Curaçao', '+670': 'East Timor',
                          ...
                          '+684': 'American Samoa', '+685': 'Samoa', '+686': 'Kiribati', '+687': 'New Caledonia',
                          '+688': 'Tuvalu', '+689': 'French Polynesia', '+690': 'Tokelau',
                          '+691': 'Federated States of Micronesia', '+692': 'Marshall Islands', '+850': 'North Korea',
                        ...
                        return countryMap[u.countryCode] || 'Unknown';
                      })() : '',
                      'LinkedIn': u.linkedin || '',
                      'Website': u.website || '',
                      'Registration Date': u.createdAt?.toDate ? u.createdAt.toDate().toLocaleDateString() : '',
                      'Last Login': u.lastLoginAt?.toDate ? u.lastLoginAt.toDate().toLocaleDateString() : 'Never'
                    }));
